<?php
// source: C:\www\parser\app/config/common.neon
// source: C:\www\parser\app/config/local.neon
// source: array
...
class Container_8a45c3be02 extends Nette\DI\Container
{
	protected $tags = [
		'nette.inject' => [
			'04' => true,
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'appDir' => 'C:\www\parser\app',
			'wwwDir' => 'C:\www\parser\www',
			'vendorDir' => 'C:\www\parser\vendor',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\www\parser\app/../temp',
		];
	}
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\www\parser\app/../temp/cache/nette.application/touch'
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\www\parser\app/../temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('C:\www\parser\app/../temp/cache', $this->getService('cache.journal'));
	}


	public function createServiceContainer(): Container_8a45c3be02
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_8a45c3be02 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\www\parser\app/../temp/cache/latte');
